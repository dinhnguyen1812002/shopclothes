                            ...
                            <div className="card">
                                <div className="card-header bg-dark p-3">
                                    <div className="card-header-flex">
                                        <h3 className="text-white m-0">Giỏ hàng {products.length > 0 ? `(${products.length})` : ''}</h3>
                                        {
                                            products.length > 0 ? <button className="btn btn-danger mt-0 btn-sm" onClick={() => emptycart()}><i className="fa fa-trash-alt mr-2"></i><span style={{fontSize: '10px'}}>Xóa giỏ hàng</span></button> : ''}
                                    </div>
                                </div>
                                                            ...
                                                            products.map((data, index) => {
                                                                ...
                                                                return (
                                                                    <tr key={index}>
                                                                        ...
                                                                        <td><div className="product-img" style={{width: '200px', height:'200px'}}><img src={API_URL + image} alt="" /></div></td>
